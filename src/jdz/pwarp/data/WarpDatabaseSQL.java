...
class WarpDatabaseSQL extends Database implements WarpDatabase{
	@Getter
	private static final WarpDatabase instance = new WarpDatabaseSQL(PlayerWarpPlugin.instance);

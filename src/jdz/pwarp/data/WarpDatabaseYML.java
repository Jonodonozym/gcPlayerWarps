...
class WarpDatabaseYML implements WarpDatabase{
	@Getter private static final WarpDatabaseYML instance = new WarpDatabaseYML(PlayerWarpPlugin.instance);
	private final FileConfiguration config = Config.getConfig(PlayerWarpPlugin.instance, "playerWarps.yml");
	private final File configFile = Config.getConfigFile(PlayerWarpPlugin.instance, "playerWarps.yml");
	private final FileLogger logger = new FileLogger(PlayerWarpPlugin.instance);
	
	private WarpDatabaseYML(PlayerWarpPlugin plugin) {
